...
func readCgroupFileLines(filePath string) (result []string, err error) {
...
func readCgroupSingleNumber(filePath string) (result int64, err error) {
...
func GetBlkioThrottleBytes(cgroupPath string) (result BlkioThrottleBytes, err error) {
...
func GetCPUAcctStats(cgroupPath string) (result []CPUAcctUsage, err error) {
...
func GetCPUSetMemoryMigrate(cgroupPath string) (result bool, err error) {
...
func GetHugetlbUsage(cgroupPath string) (result []HugetlbUsage, err error) {
...
func GetMemoryUsage(cgroupPath string) (result MemoryUsage, err error) {
...
func GetNumaStats(cgroupPath string) (result NumaStat, err error) {
...
func GetGlobalNumaStats() (result map[int]GlobalNumaStats, err error) {
	...
	for _, dir := range nodeDirs {
		...
		lines, err := readCgroupFileLines(path.Join(dir, "numastat"))
		for _, line := range lines {
			tokens := strings.Split(line, " ")
			if len(tokens) != 2 {
